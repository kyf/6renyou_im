package com.liurenyou.im.uikit;

import java.util.ArrayList;
import java.util.List;

import com.liurenyou.im.R;
import com.liurenyou.im.R.drawable;
import com.liurenyou.im.R.id;
import com.liurenyou.im.R.layout;
import com.liurenyou.im.R.string;
import com.liurenyou.im.R.style;
...
public final class MMAlert {
	...
	public static Dialog showAlert(final Context context, final String title, final String[] items, String exit, final OnAlertSelectId alertDo, OnCancelListener cancelListener) {
		...
		final Dialog dlg = new Dialog(context, style.DataSheetAnimation);
